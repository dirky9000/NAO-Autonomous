...
const int ledPin = 13; // Define a single LED pin
...
void loop() {
  ...
  // Check if any of the distances exceed 60cm and turn on the LED
  if (distance1 > 114 || distance2 > 114 || distance3 > 114 || distance4 > 114) {
